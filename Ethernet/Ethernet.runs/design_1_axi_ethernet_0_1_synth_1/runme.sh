...
HD_PWD='C:/Users/Berk/Desktop/FPGA/UMRAM/Ethernet/Ethernet.runs/design_1_axi_ethernet_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_ethernet_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_ethernet_0_1.tcl
