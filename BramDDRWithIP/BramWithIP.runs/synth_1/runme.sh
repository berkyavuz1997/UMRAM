...
HD_PWD='C:/Users/Berk/Desktop/FPGA/UMRAM/BramWithIP/BramWithIP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dizaynnn_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dizaynnn_wrapper.tcl
