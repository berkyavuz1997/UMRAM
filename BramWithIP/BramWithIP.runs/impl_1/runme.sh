...
HD_PWD='C:/Users/Berk/Desktop/FPGA/UMRAM/BramWithIP/BramWithIP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dizaynnn_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dizaynnn_wrapper.tcl -notrace
